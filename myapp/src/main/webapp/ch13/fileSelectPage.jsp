	...
	for(idx=0; idx<formName.elements.length; idx++) {
		if(formName.elements[idx].type == "file") {
			if(formName.elements[idx].value=="") {
				var message = paramIndex + "번째 파일정보가 누락되었습니다.|n 업로드할 파일을 선택해주세요.";
				alert(message);
...
<tr bgcolor="#FFCC00">
	...
	<textarea name="content" cls="40" onkeyup="inputValue(this.form,user,frmName2,2)"><%=getParam(request,"content")%></textarea>
	</td>
	</tr>
	<tr>
