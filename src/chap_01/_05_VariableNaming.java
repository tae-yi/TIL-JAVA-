...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        String _flightNo = "KE657"; // 밑줄(_) 포함
        String flight_no_2 = "KE657"; // 밑줄과 숫자 포함
        // String -flightNo = "KE657"; // 하이픈(-)은 불가능
        ...
        String item1 = "시계";
        String item2 = "가방";
        // String 3item = "전자제품"; // 변수 이름은 숫자로 시작할 수 없음
        ...
        // 절대 변하지 않는 상수는 대문자로
        final String CODE = "KR"; // 앞에 final이라는 키워드(예약어)를 붙이면 상수가 됨
